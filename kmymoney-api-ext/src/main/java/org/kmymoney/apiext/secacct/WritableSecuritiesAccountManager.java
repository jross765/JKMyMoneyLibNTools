...
public class WritableSecuritiesAccountManager extends SecuritiesAccountManager 
{
	...
	public KMyMoneyWritableAccount genShareAcct(KMyMoneySecurity sec)
	{
		...
		KMyMoneyWritableAccount acct = wrtblInvstAcct.getWritableKMyMoneyFile().createWritableAccount();
		acct.setType(KMyMoneyAccount.Type.STOCK);
		acct.setParentAccount(getInvstAcct());
		acct.setSecID(sec.getQualifID().getSecID());
		acct.setName(sec.getCode() + SEP + sec.getName());
		// ::TODO
