                                        ...
                                        implements KMyMoneyWritableAccount 
{
	...
	/**
	 * @see KMyMoneyAccountImpl#GnucashAccountImpl(GncAccount, KMyMoneyFile)
	 */
	...
	protected void setIsModified() {
		KMyMoneyWritableFile writableFile = getWritableGnucashFile();
	...
	public void setParentAccount(final KMyMoneyAccount prntAcct) {
		...
		if (parent == null) {
			parent = ((KMyMoneyWritableFileImpl) getWritableGnucashFile())
