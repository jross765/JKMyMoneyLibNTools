...
public class TestKMyMoneyWritableTransactionImpl {
	...
	assertEquals("2023-11-03", trx.getEntryDate().toString()); // unchanged
	...
	splt1.setShares(new FixedPointNumber(100).negate());
	splt1.setValue(new FixedPointNumber(100).negate());
	splt1.setDescription("Generated by TestKMyMoneyWritableTransactionImpl.test03_1 (1)");
	...
	splt2.setDescription("Generated by TestKMyMoneyWritableTransactionImpl.test03_1 (2)");
	...
	assertEquals(new FixedPointNumber(100).negate(), splt1.getShares());
	...
	assertEquals(ConstTest.Stats.NOF_TRX + 1,
		kmmOutFileStats.getNofEntriesTransactions(KMMFileStats.Type.COUNTER));
	...
	assertEquals(ACCT_20_ID, splt2.getAccountID());
	assertEquals(KMyMoneyTransactionSplit.Action.WITHDRAWAL, splt2.getAction());
	assertEquals(new FixedPointNumber(100), splt2.getShares());
	assertEquals(new FixedPointNumber(100), splt2.getValue());
	assertEquals("Generated by TestKMyMoneyWritableTransactionImpl.test03_1 (2)", splt2.getMemo());
    }
