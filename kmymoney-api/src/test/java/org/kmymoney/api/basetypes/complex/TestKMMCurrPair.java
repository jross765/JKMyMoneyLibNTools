...
public class TestKMMCurrPair {
	...
	public void test01() throws Exception {
		...
		KMMCurrPair currPr = new KMMCurrPair(secCurr1, currID2);
		...
		currPr = new KMMCurrPair(secCurr1, currID2);
		assertEquals(secCurr1, currPr.getFromSecCurr());
		assertEquals(currID2, currPr.getToCurr());
	...
	public void test02() throws Exception {
		...
		KMMCurrPair currPr = new KMMCurrPair(secID1, secCurr2);
	...
	public void test03() throws Exception {
		...
		KMMCurrPair currPr = new KMMCurrPair(currID1, currID2);
