...
public class GenTag extends CommandLineTool
{
  // Logger
  private static final Logger LOGGER = LoggerFactory.getLogger(GenTag.class);
...
//    getConfigSettings(cfg);
  ...
  protected void kernel() throws Exception
  {
    ...
    System.out.println("Tag to write: " + tag.toString());
  ...
  protected void printUsage()
  {
    ...
    formatter.printHelp( "GenTag", options );
  }
}
